          ...
          <div class="row">
            <div class="col-lg align-self-center">
              <div class="left-content show-up header-text wow fadeInBottom" id="judul" >
                <h2 style="text-align: center; color: #4da6e7;">KATEGORI BERITA </h2>
              </div>
            </div>
          </div>
        </div>
                    ...
                    <article class="blog_item">
                        ...
                        <div class="blog_details">
                            ...
                            <ul class="blog-info-link">
                                ...
                                <li><a style="font-weight: bold;" href="#"><i class="fas fa-category"></i> <span style="font-weight: bold;">kategori:</span>Olahraga</a></li>
                            </ul>
                        </div>
                    </article>
