...
<div class="container mt-5 card shadow p-5">
    ...
    <h4 class="mb-5">
      @if(Request::segment(1)==='contributor-request')
      Contributor Request
      @endif
      @if(Request::segment(1)==='contributor')
      Tambah Artikel
      @endif
    </h4>
    @if(empty($data))
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Title</label>
                <input type="text" id="title" value="{{$data->title ?? ''}}" name="title" class="form-control" placeholder="Judul kamu">
            </div>
