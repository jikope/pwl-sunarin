        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav" id="okejekk">
              ...
              @if(Auth::check())
              <li class="scroll-to-section"><a href="{{Route('contributor-request.form')}}">Daftar Contributor</a></li>
              <li class="scroll-to-section">
                
                <div class="border-first-button"><a href="{{ route('logout') }}" onclick="event.preventDefault();
